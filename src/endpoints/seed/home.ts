...
export const home: (args: HomeArgs) => RequiredDataFromCollectionSlug<'pages'> = ({
  ...
  return {
              ...
              children: [
                {
                  ...
                  mode: 'normal',
                  style: '',
                  text: 'Multimedia Entertainment Hub',
                  version: 1,
                },
              ],
              direction: 'ltr',
    ...
    meta: {
      description: 'Multimedia Entertainment Hub is a game production studio building original worlds, games and the community around them.',
      image: heroImage.id,
      title: 'Multimedia Entertainment Hub | A Game production studio',
    },
    title: 'Home',
  }
}
