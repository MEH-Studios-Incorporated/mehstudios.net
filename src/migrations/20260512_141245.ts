...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_variant" AS ENUM('gradient', 'black', 'primary');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_cta_variant" AS ENUM('gradient', 'black', 'primary');
  ...
  CREATE TYPE "public"."enum_header_sign_in_button_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE "pages_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"variant" "enum_pages_blocks_cta_variant" DEFAULT 'gradient',
  	"rich_text" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"variant" "enum__pages_v_blocks_cta_variant" DEFAULT 'gradient',
  	"rich_text" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"sign_in_button_type" "enum_header_sign_in_button_type" DEFAULT 'reference',
  	"sign_in_button_new_tab" boolean,
  	"sign_in_button_url" varchar,
  	"sign_in_button_label" varchar NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_header_sign_in_button_type";
